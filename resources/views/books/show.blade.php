            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex transition-all duration-250">
                    <div>
                        ...
                        <img src="{{ !empty($book->cover) ? asset('storage/' . $book->cover) : 'https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png' }}" alt="">
                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            {{ $book->description }}
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid aspernatur enim fuga harum in ipsa ipsum iusto maiores minus natus obcaecati odit, optio placeat, quas quisquam, tempore tenetur vero voluptatem. Lorem ipsum dolor sit amet, consectetur adipisicing elit. A ab at consequuntur deserunt doloribus ea earum esse harum, ipsa magnam maiores neque non odio perspiciatis quas quo quod ullam veniam!
                        </p>
                    </div>
